Pro hclvarbbound2b, tvmin,tvmax,wps,smo,eb1,eb2,eb3,ee1,ee2,ee3,strnn,$
...
nef=0.2 & ddscx=scmaxx-scminx & ddscy=scmaxy-scminy & ddscz=scmaxz-scminz
nefx=nef*ddscx & nefy=nef*ddscy & nefz=nef*ddscz
;!P.POSITION=[0.1,0.1,0.9,0.9]
if isc eq 1 then begin
 if wps ne 'y' then begin
  if satraj eq 1 then wset,1
  if satraj eq 0 then wset,0
 endif
if satraj ne 1 and satraj ne 0 then goto,ending
plots,[scdp1(0,its),scdp1(0,its)+nefx*ef3(0)],[scdp1(1,its),$
       scdp1(1,its)+nefy*ef3(1)],[scdp1(2,its),scdp1(2,its)+nefz*ef3(2)],/T3D
plots,[scdp1(0,its),scdp1(0,its)+nefx*ef3(0)],[scdp1(1,its),$
       scdp1(1,its)+nefy*ef3(1)],[!Z.Crange[0],!Z.Crange[0]],linestyle=3,/T3D
plots,[!X.Crange[1],!X.Crange[1]],[scdp1(1,its),$
...
plots,[scdp2(0,its),scdp2(0,its)+nefx*ef3(0)],[scdp2(1,its),$
       scdp2(1,its)+nefy*ef3(1)],[scdp2(2,its),scdp2(2,its)+nefz*ef3(2)],/T3D
plots,[scdp2(0,its),scdp2(0,its)+nefx*ef3(0)],[scdp2(1,its),$
       scdp2(1,its)+nefy*ef3(1)],[!Z.Crange[0],!Z.Crange[0]],linestyle=3,/T3D
plots,[!X.Crange[1],!X.Crange[1]],[scdp2(1,its),$
...
plots,[scdp3(0,its),scdp3(0,its)+nefx*ef3(0)],[scdp3(1,its),$
       scdp3(1,its)+nefy*ef3(1)],[scdp3(2,its),scdp3(2,its)+nefz*ef3(2)],/T3D
plots,[scdp3(0,its),scdp3(0,its)+nefx*ef3(0)],[scdp3(1,its),$
       scdp3(1,its)+nefy*ef3(1)],[!Z.Crange[0],!Z.Crange[0]],linestyle=3,/T3D
plots,[!X.Crange[1],!X.Crange[1]],[scdp3(1,its),$
...
plots,[scdp4(0,its),scdp4(0,its)+nefx*ef3(0)],[scdp4(1,its),$
       scdp4(1,its)+nefy*ef3(1)],[scdp4(2,its),scdp4(2,its)+nefz*ef3(2)],/T3D
plots,[scdp4(0,its),scdp4(0,its)+nefx*ef3(0)],[scdp4(1,its),$
       scdp4(1,its)+nefy*ef3(1)],[!Z.Crange[0],!Z.Crange[0]],linestyle=3,/T3D
plots,[!X.Crange[1],!X.Crange[1]],[scdp4(1,its),$
       scdp4(1,its)+nefy*ef3(1)],[scdp4(2,its),scdp4(2,its)+nefz*ef3(2)],$
       linestyle=2,/T3D
endif
