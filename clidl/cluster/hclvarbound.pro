Pro hclvarbound, tvmin,tvmax,withps,smo,eb1,eb2,eb3,ee1,ee2,ee3,strnn
  ...
  print, '  Number of data points:', nnn
   ...
   plots, ft(2,nnn-1), ft(0,nnn-1), psym=2
    ...
    xyouts, .7, .94, '!17Variance Interval '+$
      string(tvmin,'(f5.1)')+' - '+string(tvmax,'(f5.1)')+'!3', /norm
   ...
   xyouts, .70, .3+dpo, xtit1+' = '+string(ef1(0),'(f7.4)'), /norm
   xyouts, .70, .27+dpo, '     '+string(ef1(1),'(f7.4)'), /norm
   xyouts, .70, .24+dpo, '     '+string(ef1(2),'(f7.4)'), /norm
   xyouts, .70, .2+dpo, xtit2+' = '+string(ef2(0),'(f7.4)'), /norm
   xyouts, .70, .17+dpo, '     '+string(ef2(1),'(f7.4)'), /norm
   xyouts, .70, .14+dpo, '     '+string(ef2(2),'(f7.4)'), /norm
   xyouts, .70, .1+dpo, ytit+' = '+string(ef3(0),'(f7.4)'), /norm
   xyouts, .70, .07+dpo, '     '+string(ef3(1),'(f7.4)'), /norm
   xyouts, .70, .04+dpo, '     '+string(ef3(2),'(f7.4)'), /norm
