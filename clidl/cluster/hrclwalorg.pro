...
; DHT AND WALEN TEST Parameters
  ...
  if ( (whatindex eq 's') or $
     ...
     hcltestvar,timep1,timep3,timep4,ncis1,ncis3,ncis4,tmin,tmax,isc,smo,iterror
     ...
     hclwalendht,itest,smo,tmin,tmax,delt,fdelt,$
                 slwal0,slwal1,slht0,slht1,t1a,t2a,totnumint,wps
     if whatindex eq 'p' then begin
       wps='n' & close,7
     endif
