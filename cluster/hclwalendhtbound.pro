Pro hclwalendhtbound,itest,smo,trmin,trmax,delt,fdelt,$
...
dscmin3=1.1*min(re*rsc(*,its:ite)+scdr1(*,its:ite))
dscmax3=1.1*max(re*rsc(*,its:ite)+scdr1(*,its:ite))
endif

if satraj eq 3 then begin
dscmin3=1.1*min(re*rsc(*,its:ite)+scdr3(*,its:ite))
dscmax3=1.1*max(re*rsc(*,its:ite)+scdr3(*,its:ite))
endif

if satraj eq 4 then begin
dscmin3=1.1*min(re*rsc(*,its:ite)+scdr4(*,its:ite))
dscmax3=1.1*max(re*rsc(*,its:ite)+scdr4(*,its:ite))
endif
...
sat1:
if satraj ne 3 and satraj ne 4 then begin
if satraj eq 0 then wset,0
  if satraj eq 1 then begin
wset,1
dscmin2=dscmin3
dscmax2=dscmax3
   scdr1(0,its:ite)=re*rsc(0,its:ite)+scdr1(0,its:ite)
   scdr1(1,its:ite)=re*rsc(1,its:ite)+scdr1(1,its:ite)
   scdr1(2,its:ite)=re*rsc(2,its:ite)+scdr1(2,its:ite)
  endif
...
plot_3dbox,scdr1(0,its:ite),scdr1(1,its:ite),scdr1(2,its:ite),$
   ...
   ZTITLE='Z ', SUBTITLE='', $
   /YSTYLE, $
   XRANGE=[dscmin2,dscmax2],$
   YRANGE=[dscmin2,dscmax2],ZRANGE=[dscmin2,dscmax2],$
   PSYM=-4, CHARSIZE=1.6,/noerase
endif

sat2:
if satraj ne 1 and satraj ne 3 or satraj ne 4 then begin

if satraj eq 0 then wset,0
  if satraj eq 2 then begin
wset,1
dscmin2=dscmin3
dscmax2=dscmax3
   scdr2(0,its:ite)=re*rsc(0,its:ite)+scdr2(0,its:ite)
   scdr2(1,its:ite)=re*rsc(1,its:ite)+scdr2(1,its:ite)
   scdr2(2,its:ite)=re*rsc(2,its:ite)+scdr2(2,its:ite)
  endif
...
plot_3dbox,scdr2(0,its:ite),scdr2(1,its:ite),scdr2(2,its:ite),$
   ...
   XTITLE='X ', YTITLE='Y ', $
   ZTITLE='Z ', SUBTITLE='', $
   /YSTYLE, XRANGE=[dscmin2,dscmax2],YRANGE=[dscmin2,dscmax2],$
   ZRANGE=[dscmin2,dscmax2],PSYM=-4, CHARSIZE=1.6,/noerase,color=yell
endif

sat3:
if satraj ne 1 and satraj ne 4 then begin
if satraj eq 0 then wset,0
  if satraj eq 3 then begin
wset,1
dscmin2=dscmin3
dscmax2=dscmax3
   scdr3(0,its:ite)=re*rsc(0,its:ite)+scdr3(0,its:ite)
   scdr3(1,its:ite)=re*rsc(1,its:ite)+scdr3(1,its:ite)
   scdr3(2,its:ite)=re*rsc(2,its:ite)+scdr3(2,its:ite)
  endif
!P.POSITION=[0.1,0.1,0.9,0.9]
...
;if satraj eq 3 then goto,bounds
endif

sat4:
if satraj ne 1 and satraj ne 3 then begin
if satraj eq 0 then wset,0
  if satraj eq 4 then begin
wset,1
dscmin2=dscmin3
dscmax2=dscmax3
   scdr4(0,its:ite)=re*rsc(0,its:ite)+scdr4(0,its:ite)
   scdr4(1,its:ite)=re*rsc(1,its:ite)+scdr4(1,its:ite)
   scdr4(2,its:ite)=re*rsc(2,its:ite)+scdr4(2,its:ite)
  endif
!P.POSITION=[0.1,0.1,0.9,0.9]
plot_3dbox,scdr4(0,its:ite),scdr4(1,its:ite),scdr4(2,its:ite),$
   ...
   XRANGE=[dscmin2,dscmax2],YRANGE=[dscmin2,dscmax2],$
   ZRANGE=[dscmin2,dscmax2],$
   PSYM=-4, CHARSIZE=1.6,/noerase,color=red
printf,55,scdr4(0,its:ite),its,ite
;if satraj eq 4 then goto,bounds
endif
...
hclvarbbound1a, tvmin,tvmax,withps,smo,eb1,eb2,eb3,ee1,ee2,ee3,strnn,$
