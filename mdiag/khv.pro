...
;     trange = max(time(*,0:(nop-1)))
    ...
    ypos3=-3.7
    ypos4=-4.4
	xyouts,xpos,ypos0,'315'
	xyouts,xpos,ypos1,'252'
	xyouts,xpos,ypos2,'294'
	xyouts,xpos,ypos3,'336'
	xyouts,xpos,ypos4,'378'
    xpost=0.7*trange
    ypost=-3
    xyouts,xpost,ypost,'v!Dsh!N:',size=1.5
    xposy=0.05*trange
    yposy=0
