...
;    print, zeit
    ...
    readf, 2, r1,r1,r1,r1,r2,r3
    jp(i,iop)=r1 & xjp(i,iop)=r2 & yjp(i,iop)=r3 
   
    for k=0,17 do  readf, 2, format='(a80)', dumm
    itot(iop)=i
  ...
  close, 2
   ...
   while again eq 'y' do begin
    ...
    if (contin eq '' or contin eq 'y') then begin
     ...
     plot, time(2:itot(0),0), smooth(jp(2:itot(0),0),3),$
        title='Minimal By',$
        xtitle='t', font=3, xrange=[0,trange], yrange=[0, 1.]
     for k=1,nop-1 do  oplot, time(2:itot(k),k), smooth(jp(2:itot(k),k),3), line=k
    endif
