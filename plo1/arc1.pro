...
;    js-sheet current in A/m; j-current density in A/m^2
  ...
  db = db0*sqrt(b0/br0)  & db1 = db0*(b0/br0)^(1.0/3.0)
...
; 7c) Normalisation factor for resistivity (resphys=resfac*res in ohm*m):
  resfac=0.05*eash/j/1000.
  resfac1=0.05*eash1/j1/1000.
...
;12) Resitivities (Inverse=magnetic Reynolds Number)
  res=eta*eash/j/1000.
  res1=eta1*eash1/j1/1000.
