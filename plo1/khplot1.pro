...
print, rho1*rho2/(rho1+rho2)^2*v0^2
print, (b1^2+b2^2)*sin(phi0)^2/(rho1+rho2)

  for i=0,nx-1 do begin
    if ( v(i)^2 ge (rho1+rho2)/rho1/rho2*(b1^2+b2^2) $
                        *sin(phi0)^2 ) $
      then q1(i)=sqrt( rho1*rho2/(rho1+rho2)^2*v(i)^2 $
                       -(b1^2+b2^2)*sin(phi0)^2/(rho1+rho2) ) $
      else q1(i)=0.0
    if ( v(i)^2 ge (rho1+rho2)/rho1/rho2*(b1^2+b2^2) $
                      *sin(phi1)^2 ) $
      then q2(i)=sqrt( rho1*rho2/(rho1+rho2)^2*v(i)^2 $
                       -(b1^2+b2^2)*sin(phi1)^2/(rho1+rho2) ) $
      else q2(i)=0.0
    if ( v0^2 ge (rho1+rho2)/rho1/rho2*(b1^2+b2^2) $
                     *sin(phi(i))^2 ) $
      then q3(i)=sqrt( rho1*rho2/(rho1+rho2)^2*v0^2 $
                       -(b1^2+b2^2)*sin(phi(i))^2/(rho1+rho2) ) $
      else q3(i)=0.0
    if ( v0^2 ge (rho1+rho2)/rho1a/rho2*(b1^2+b2^2) $
                     *sin(phi(i))^2/cos(phi(i))^2 ) $
      then q4(i)=sqrt( rho1*rho2/(rho1+rho2)^2*v0^2*cos(phi(i))^2  $
                       -(b1^2+b2^2)*sin(phi(i))^2/(rho1+rho2) ) $
      else q4(i)=0.0
  endfor
...
;  if (contin eq '' or contin eq 'y') then begin
    ...
    amax = max([q3*q0,q4*q0,.04])
;    amax = max([q3*q0,q4*q0])
    amin = min([0.,q3*q0,q4*q0])
