...
asymval, nx,ny,vzpro,vz1,vz2,vzav  
 print, 'vz_msp_orig = ', vz1,'  vz_msh_orig = ',vz2,'   vzav = ',vzav
   ...
   for i=0,nfl-1 do if (yt(i) lt y(0)) then yt(i)=yt(i)+y(ny-1)-y(0)
   for i=0,nfl-1 do if (yt(i) gt y(ny-1)) then yt(i)=yt(i)-y(ny-1)+y(0)
...
p1:  
    tit=' Plasma Velocity' & tit2='Total pressure'    
    if contonly eq 'y' then begin
