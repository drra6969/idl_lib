...
read2dk, g1,g2,g3,h1,h2,h3, bx,by,bz, vx,vy,vz, rho,u,res
...
p2:
;    !P.MULTI=[0,3,0,0,0]
    tit=' Magnetic Field+Bz_msp' & tit2='Bz' 
    if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, bzpro,a,bx,by,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
