...
p1:  
    ...
    tit=' Plasma Velocity vx' & tit2='Vz'    
    if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, vx,a,vx,vy,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
...
p2:
    ...
    tit=' Magnetic Field + jx' & tit2='Bx' 
    if contonly eq 'y' then begin
     ctvec, a,bx,by,pos1,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
     ctsca2, vx,pos3,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
    end else begin
    !P.MULTI=[0,5,0,0,0]
    vcplot, jx,a,bx,by,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
