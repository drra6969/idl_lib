...
p1:  
    tit='Velocity and Magnetic Field' & tit2='Density'    
    if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, bz,a,vx,vy,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,$
             smo,aval
...
p2:
    tit=' Magnetic Field' & tit2='Total Pressure' 
    if contonly eq 'y' then begin
...
p3:
   ...
   if contonly eq 'y' then begin
    ...
    vcplot, rho,a,bx,by,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,$
             smo,aval
