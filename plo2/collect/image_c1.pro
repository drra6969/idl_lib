...
pro image_c, a, WINDOW_SCALE = window_scale, ASPECT = aspect, $
	INTERP = interp
;+
; NAME:
;	IMAGE_CONT
...
if (!d.flags and 1) ne 0 then begin	;Scalable pixels?
  ...
  tvscl,top=ccc+100,a,px(0),py(0),xsize = swx, ysize = swy, /device

endif else begin	;Not scalable pixels	
   if keyword_set(window_scale) then begin ;Scale window to image?
	tvscl,top=ccc+100,a,px(0),py(0)	;Output image
	...
	tvscl,poly_2d(bytscl(a,top=ccc),$	;Have to resample image
