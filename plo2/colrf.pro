...
p1:  
    tit='Velocity, Field Lines and B_y' & tit2='Total pressure'    
    if contonly eq 'y' then begin
...
p2:
    tit=' Velocity, Field Lines and Vy' & tit2='B_y' 
    if contonly eq 'y' then begin
...
p3:
   ...
   if contonly eq 'y' then begin
    ...
    vcfplot, rho,a,bx,by,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,$
             smo,aval,xt,yt
