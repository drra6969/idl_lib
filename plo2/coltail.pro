; MAIN PROGRAM
;   program reads data from 2D simulations(x/y) for tail simulations 
...
;--------------------
   ...
   nl1=21  &  nl2=9  &  phi=0.0  &  pi = 3.14159265536  &  phir = phi*pi/180.0
  ...
  print,size(bx),'sizebx1'

; READ INPUT DATA OF DIMENSION NX, NY
read2dtail, g1,g2,g3,h1,h2,h3, bx,by,bz, vx,vy,vz, rho,u,res
   ...
   print,size(bx),'sizebx2'

;   print, 'Which case?'
;   read, run

   testbdtail, nx,ny,x,y,xmin,xmax,ymin,ymax   
...
p1:  
    ...
    fc=interpolate(vzpro,ioxf,ioyf,/grid) 
    fn1=interpolate(vx,iox,ioy,/grid)
    fn2=interpolate(vy,iox,ioy,/grid)
    tit=' Plasma Velocity' & tit2='Jy'    
   if contonly eq 'y' then begin
    ...
    scaplot2, fa,pos3,pos4,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
   endelse
  goto, menu
