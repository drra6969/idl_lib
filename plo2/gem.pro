...
p1:  
    tit='Plasma Velocity and Current Density' & tit2='Density'    
   if contonly eq 'y' then begin
...
p2:
    tit=' Magnetic and Electric Field' & tit2='Total Pressure' 
   if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, ez,a,bx,by,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
