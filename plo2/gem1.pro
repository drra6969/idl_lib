...
jande1, nx,ny,g1,h1,bx,by,vx,vy,res,jz,ez
...
p1:  
    tit='Plasma Velocity and Current Density' & tit2='Total Pressure'    
   if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, jz,a,vx,vy,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
    scplot2, p+bsq,pos3,pos4,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
   endelse
  goto, menu
	
p2:
    tit='Magn Field, Vel and B_y' & tit2='V_y' 
   if contonly eq 'y' then begin
    ...
    !P.MULTI=[0,5,0,0,0]
    vcplot, bz,a,vx,vy,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo,aval
    scplot2, vz,pos3,pos4,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
   endelse
  goto, menu
...
p5:
    ...
    fb=interpolate(vz,ioxf,ioyf,/grid)
    tit='Electric field E_z' & tit2='Resistivity'
   if contonly eq 'y' then begin
    ctsca1, bx,pos1,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo
    ctsca2, vx,pos3,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
   end else begin
    scplot1, ez,pos1,pos2,xpos,ypos,nl1,nl2,names,tit,xtit0,ytit,smo
    scplot2, res,pos3,pos4,xpos,ypos,nl1,nl2,names,tit2,xtit,ytit1,smo
   endelse
  goto, menu
