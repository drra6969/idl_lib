...
;--------------------
   ...
   wlong=900 & wshort=720 & wfact=0.8 &  wxf=1.0 & wyf=1.0 & psfact=0.9
...
; VECTORPOTENTIAL:
vecpot1, nx,ny,x,y,bx,by,a,fmin,fmax
    ...
    jz=jz(*,1:ny-2)   & ez=ez(*,1:ny-2) & a=a(*,1:ny-2)
...
p2:
    ...
    fb=interpolate(a,ioxf,ioyf,/grid)
    fc=interpolate(bzpro,ioxf,ioyf,/grid) 
