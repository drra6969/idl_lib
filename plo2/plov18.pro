...
;        TRIANGULATE, X, Y, tri	
	...
	contour,source,x,y,levels=lvec,$
;	contour,phix,x,y,levels=lvec, TRIANGULATION = tri,$
        title=' Source',xstyle=4,ystyle=4,$
        xtitle=' ',ytitle='y'
...
;        lvec(0)=lvecmax & for i=1,nlevels-1 do lvec(i)=0.84*lvec(i-1)
	...
	xyouts,xpos,ypos2,'lambda: '+string(lambda,'(f6.2)')
	xyouts,xpos,ypos3,'Alpha: '+string(alpha,'(f6.2)')

;        PLOT, x, y, psym=1,xstyle=4,ystyle=4
        axis, xax=0, -0.05,-0.05, xtitle='x'
        axis, yax=0, -0.05,-0.05, ytitle='y'
