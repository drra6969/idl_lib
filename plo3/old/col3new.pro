...
;-----------PARAMETER----------------
  xmin = 0. & ymin = -12.6  & zmin = -12.6
  xmax = 6.3 & ymax = 12.6   & zmax = 12.6
...
menu:
  ...
  if choice eq 'p' then begin 
    withps = 'y'
    set_plot,'ps'
    ncol=!D.TABLE_SIZE & print,!D.TABLE_SIZE
...
plota:  
;   PLOTA
;    if coltab eq 'o' then setcol,withps
...
;  nl=9
  if contonly eq 'y' then begin
     ...
     cont2, pos3,xpos,ypos,nl1,nl2,names,head2,xtit,ytit1,smo,plane
  end else begin
     sca1,pos1,pos2,xpos,ypos,nl1,nl2,names,head1,xtit0,ytit,smo,plane
     sca2,pos3,pos4,xpos,ypos,nl1,nl2,names,head2,xtit,ytit1,smo,plane
  endelse
  goto, menu
...
;    if coltab eq 'o' then setcol,withps
  ...
  if contonly eq 'y' then begin
    ...
    vecp, pos1,pos2,xpos,ypos,nl1,nl2,names,head4,xtit0,ytit,smo,plane
    sca2, pos3,pos4,xpos,ypos,nl1,nl2,names,head5,xtit,ytit1,smo,plane
  endelse
  goto, menu
