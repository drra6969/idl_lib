PRO sca1arc, pos1,pos2,xpos,ypos,nl1,nl2,names,titl,xtitl,ytitl,smo,plane


COMMON program_par, nx,nxn,nxf, ny,nyn,nyf, nz,nzn,nzf,$
                    x,y,z, xf,yf,zf, xn,yn,zn, iox,ioy,ioz, $
                    ioxf,ioyf,iozf,run,time,xmark,ymark
COMMON program_var, fp1,fp2,xsu,ysu,f0,xchoice,ychoice,far1,far2,xar,yar,$
                    cutata,cutatb


        if (titl eq 'Resistivity') or (titl eq 'E parallel') then $
                  ytickf='(f7.4)' else ytickf='(f5.2)' 
...
;        c_linestyle=0,$
        ...
        print,'!!!!!!!!!!!!!!!!!!!!!!!'
        print,'XYmark:',xmark,ymark
        oplot,xmark,ymark,psym=1
