...
gmax1=0.55 & bmax1=0.85 & bmax2=0.5 & rmax1=1.0 & vmax1=0.5


;int1a:
for i=i0,i1aa do r(i) = float(i)*vmax1/float(i1aa) 
for i=i0,i1aa do b(i) = float(i)*vmax1/float(i1aa) 
...
;int4:
g(i3:i6a)=0.
b(i3:i4a)=bmax1 &  for i=i3,i6a do r(i)=(i-i3)*rmax1/(float(i6a)-float(i3))

;int5:
for i=i4a,i6 do b(i)=(i6-i)*bmax1/(float(i6)-float(i4a))
