...
gmax1=0.85 & bmax1=0.85 & bmax2=0.5 & rmax1=1.0 & vmax1=0.5 & vmax2=0.25

if withgrey eq 'y' then begin
  ;int1+2:
  for i=i0,i2 do r(i)=i*gmax1/float(i4) 
  ;int3-6:
  for i=i1,i4 do r(i)=(i-i2)*gmax1/float(i4)+0.1*gmax1
  ;int7+8:
  for i=i4,i6 do r(i)=(i-i4)*gmax1/float(i4)+0.2*gmax1
  for i=i6,i8 do r(i)=(i-i6)*gmax1/float(i4)+0.3*gmax1
