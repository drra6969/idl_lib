PRO PRINTPL, nt, tmin,tmax,evv1,evv2,evv3,ewv,vav,evb1,evb2,evb3,ewb,bav,$
...
; plots of b, v, and e in coordinates of e1, e2, and e3
  ...
  xyouts, .55, .21, 'B!dMSP!n:', /norm
  xyouts, .67, .21, string(bmsp(0),'(f7.2)'), /norm
  xyouts, .77, .21, string(bmsp(1),'(f7.2)'), /norm
  xyouts, .87, .21, string(bmsp(2),'(f7.2)'), /norm
  xyouts, .55, .18, 'B!dMSH!n:', /norm
  xyouts, .67, .18, string(bmsh(0),'(f7.2)'), /norm
  xyouts, .77, .18, string(bmsh(1),'(f7.2)'), /norm
  xyouts, .87, .18, string(bmsh(2),'(f7.2)'), /norm
  xyouts, .55, .14, 'V!dMSP!n:', /norm
  xyouts, .67, .14, string(vmsp(0),'(f7.2)'), /norm
  xyouts, .77, .14, string(vmsp(1),'(f7.2)'), /norm
  xyouts, .87, .14, string(vmsp(2),'(f7.2)'), /norm
  xyouts, .55, .11, 'V!dMSH!n:', /norm
  xyouts, .67, .11, string(vmsh(0),'(f7.2)'), /norm
  xyouts, .77, .11, string(vmsh(1),'(f7.2)'), /norm
  xyouts, .87, .11, string(vmsh(2),'(f7.2)'), /norm
  
  xyouts, .55, .07, 'Density/Temp_MSP:', /norm
  xyouts, .77, .07, string(rhotmsp(0),'(f7.2)'), /norm
  xyouts, .87, .07, string(rhotmsp(1),'(f7.2)'), /norm
  xyouts, .55, .04, 'Density/Temp_MSH:', /norm
  xyouts, .77, .04, string(rhotmsh(0),'(f7.2)'), /norm
  xyouts, .87, .04, string(rhotmsh(1),'(f7.2)'), /norm
