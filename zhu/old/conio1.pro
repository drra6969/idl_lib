...
; READ INPUT DATA OF DIMENSION NX, NY
   ...
   a=fltarr(nx,ny) 
   vnx=bx & vny=bx & vnz=bx  & rhon=bx & un=bx & rhon1=bx & un1=bx 
   res=bx & nu12s=bx 
...
;        device,/times,/bold,font_index=3
  ...
  print, 'plot first page? Rhon, Pn, flow vectors'
  read, contin
...
;       !P.REGION=[0.,0.,1.0,1.25]
       ...
       !Y.RANGE=[ymin,ymax]
        ...
        fa=interpolate(rhon-rhon1,ioxf,ioyf,/grid)
...
;        vect, fn1, fn2, xn, yn, length=0.8*fmax,$
	...
	xyouts,xpos,ypos4,'  '+string(fmax,'(f7.4)')
        ...
        fa=interpolate(un-un1,ioxf,ioyf,/grid) 
...
;        del=(bmax-bmin)/15.
	...
	contour,fa,xf,yf,levels=findgen(12)*del+bmin+0.01,$
        ...
        title=' Un !9 r !X',xstyle=1,ystyle=1,$
  ...
  print, 'continue with next plot, Vnx,Vny',$
