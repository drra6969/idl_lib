...
;-----------------------------------------------------------------------
; 2nd page ( electron pressure and velocity)
;-----------------------------------------------------------------------
...
;        bmin=min([f4]) & print, 'P min: ',bmin
        ...
        delb=bmax-bmin
        xpos=pmax+0.015*(pmax-pmin)
	plot, f4(*,0), plcoo, title='Electron Pressure', $
	xrange=[bmin,bmax],xstyle=1,ystyle=1,ytitle='z',line=0
...
;        bmin=min([f5]) & print, 'Vel min: ',bmin
        ...
        ypos1=pmin+0.4*delb 
        ypos3=pmin+0.26*delb 
	plot, f5(*,0), plcoo, title='Velocity', $
	xrange=[bmin,bmax],xstyle=16,ystyle=1,ytitle='z',xticks=4,line=0
...
;-----------------------------------------------------------------------
; 3rd page ( electron pressure and velocity)
;-----------------------------------------------------------------------
...
;        bmin= 0.2
        ...
        ypos1=pmin+0.4*delb 
        ypos3=pmin+0.26*delb 
	plot, f6(*,0), plcoo, title='Pressure', $
	xrange=[bmin,bmax],xstyle=16,ystyle=1,ytitle='z',xticks=4,line=0
