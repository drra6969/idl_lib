...
;       !P.REGION=[0.,0.,1.0,1.25]
       ...
       ff = v_units*vz
;       tt = ta_time*time
       contplot, ff,xa1,xa2,ylo,yup,'(E8.1)',xtit,tit,tt,15,1
       
       tit = ' Magnetic Field By (nT) '
       xtit = ' '
       ff = b_units*bz
;       tt = ta_time*time
       contplot, ff,xe2,xe3,ylo,yup,'(f7.2)',xtit,tit,tt,15,1
;       
...
;save,file='ray2drl.dat',/xdr,x,y,f6300
...
save,file='ray2dte.dat',/xdr,x,y,ff
...
;        fmax=max(sqrt(fn1^2+fn2^2))
	...
	xyouts,xpos,ypos4,' '+string(fmax,'(f7.2)')+ ' '
        ...
        f1=smooth(vx,3)
        f2=smooth(vy,3)
        fn1=interpolate(v_units*f1,iox,ioy,/grid)
        fn2=interpolate(v_units*f2,iox,ioy,/grid)
