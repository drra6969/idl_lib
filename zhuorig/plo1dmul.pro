...
;	oplot, plcoo, f2, line=1
	...
	xyouts,xpos,ypos4,plane+' ='+string(y(igrid),'(f6.2)')
...
;	oplot, plcoo, f12, line=1
	xyouts,xpos,ypos0,'time:'
	xyouts,xpos,ypos1,' '+string(ta_time*time,'(f6.2)')+'s'
	xyouts,xpos,ypos3,plane+' ='+string(y(igrid),'(f6.2)')
...
;        bmax=10000.0 & bmin=1850.0
        ...
        ypos3=bmin+delb/64. 
        ypos4=bmin+delb/128. 
	plot, plcoo, t_units*f13a(*,0),title='Electron Temperature  (1000 K)', $
	  yrange=[bmin,bmax],xstyle=1,ystyle=1
        for it=2,ntmax,2 do begin
...
;save,file='/why1/zhu/io2d/gradpe/agu/data/curr/curr/out.dat',$
