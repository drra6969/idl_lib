...
;        bmin=min([ne1,ne2,ne3]) & print, 'Ti min: ',bmin
	...
	oplot, [-11.5,-10],[2.8e5,2.8e5],line=2
	xyouts,-9.7,2.78e5,hight3
	oplot, [-11.5,-10],[2.55e5,2.55e5],line=1
	xyouts,-9.7,2.53e5,hight2
	oplot, [-11.5,-10],[2.3e5,2.3e5]
	xyouts,-9.7,2.28e5,hight1	
